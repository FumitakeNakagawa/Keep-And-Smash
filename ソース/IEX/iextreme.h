...
public:
	...
	void Activate();
public:
	bool ConversionScreen(Vector3& out, const Vector3 pos)
	{
		return ConversionScreen(out, pos, matView* matProjection);
	}
	bool ConversionScreen(Vector3& out, const Vector3 pos, const Matrix& mat);
...
public:
	...
	int	RayPick2(Vector3& out, Vector3& pos, Vector3& vec, float &Dist);
